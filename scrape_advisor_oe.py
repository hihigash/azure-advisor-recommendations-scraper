...
def parse_html(html):
    ...
    for element in content.find_all(['h2', 'h4']):
        if element.name == 'h2':
            ...
            id = element.get('id')
            base_url = "https://learn.microsoft.com/en-us/azure/advisor/advisor-reference-operational-excellence-recommendations"
...
def main():
    ...
    filename = "azure_advisor_operational_excellence_recommendations.json"
